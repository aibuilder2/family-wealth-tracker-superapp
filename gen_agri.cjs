...
fs.mkdirSync('app/(dashboard)/agriculture', { recursive: true });
fs.writeFileSync('app/(dashboard)/agriculture/page.tsx', code.trim() + '\n', 'utf8');
console.log('Saved app/(dashboard)/agriculture/page.tsx');
