...
const scannerModalCode = `'use client';
...
fs.mkdirSync('components/scanner', { recursive: true });
fs.writeFileSync('components/scanner/KaagazScannerModal.tsx', scannerModalCode.trim() + '\n', 'utf8');
console.log('Created components/scanner/KaagazScannerModal.tsx');
