...
const fleetPageCode = `'use client';
...
fs.mkdirSync('app/(dashboard)/fleet', { recursive: true });
fs.writeFileSync('app/(dashboard)/fleet/page.tsx', fleetPageCode.trim() + '\n', 'utf8');
console.log('Saved app/(dashboard)/fleet/page.tsx');
