...
fs.writeFileSync('app/(dashboard)/cases/page.tsx', casesCode.trim() + '\n', 'utf8');
console.log('Upgraded app/(dashboard)/cases/page.tsx with Lawyer Fee & Peshi Ledger');
