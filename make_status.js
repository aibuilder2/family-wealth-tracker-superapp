...
const content = `# Family Wealth App — Project Status & Handover Documentation
...
fs.writeFileSync(path.join(__dirname, 'PROJECT_STATUS.md'), content, 'utf8');
console.log('PROJECT_STATUS.md successfully created inside family-wealth-app folder.');
