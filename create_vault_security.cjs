...
const vaultSecurityCode = `// lib/crypto/vaultSecurity.ts
...
fs.mkdirSync('lib/crypto', { recursive: true });
fs.writeFileSync('lib/crypto/vaultSecurity.ts', vaultSecurityCode.trim() + '\n', 'utf8');
console.log('Created lib/crypto/vaultSecurity.ts');
