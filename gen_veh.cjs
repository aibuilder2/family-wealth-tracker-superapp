...
fs.mkdirSync('app/(dashboard)/vehicles', { recursive: true });
fs.writeFileSync('app/(dashboard)/vehicles/page.tsx', code.trim() + '\n', 'utf8');
console.log('Saved app/(dashboard)/vehicles/page.tsx');
