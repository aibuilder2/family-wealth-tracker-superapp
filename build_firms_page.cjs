...
fs.mkdirSync('app/(dashboard)/firms', { recursive: true });
fs.writeFileSync('app/(dashboard)/firms/page.tsx', firmsCode.trim() + '\n', 'utf8');
console.log('Saved app/(dashboard)/firms/page.tsx');
